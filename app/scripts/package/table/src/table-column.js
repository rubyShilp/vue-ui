...
const defaults = {
  ...
  selection: {
    ...
    realWidth: 48,
    order: '',
    className: 'fa-table-column--selection'
  },
  expand: {
    width: 48,
    minWidth: 48,
...
const forced = {
  ...
  expand: {
    ...
    renderCell: function(h, { row, store }, proxy) {
      ...
      return <div class={ 'fa-table__expand-icon ' + (expanded ? 'fa-table__expand-icon--expanded' : '') }
        on-click={ e => proxy.handleExpandClick(row, e) }>
        <i class='fa-icon fa-icon-arrow-right'></i>
      </div>;
    },
    sortable: false,
    resizable: false,
    className: 'fa-table__expand-column'
  }
};
