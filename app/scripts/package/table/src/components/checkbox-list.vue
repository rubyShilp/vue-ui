<template>
    <div :class="[
        ...
        <div class="fa-checkbox-item checked-all" :style="getItemStyle(0, false)">
        ...
        <div ref="list" :style="{
            ...
            <ul class="fa-checkbox-list" :style="{height: this.list.length * this.h + 'px'}">
