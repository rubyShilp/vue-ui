                  ...
                  this._l(columns, (column, cellIndex) =>
                    <th
                      ...
                      <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                        ...
                        {
                          column.filterable
                            ? <span class="fa-table__column-filter-trigger" on-click={ ($event) => this.handleFilterClick($event, column) }><i class={ ['fa-icon-arrow-down', column.filterOpened ? 'fa-icon-arrow-up' : ''] }></i></span>
                            : ''
                        }
                      </div>
                    </th>
