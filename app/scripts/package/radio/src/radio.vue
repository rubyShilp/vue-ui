<template>
  <label
    class="fa-radio"
    :class="[
      border && radioSize ? 'fa-radio--' + radioSize : '',
  ...
  >
    ...
    >
      <span class="fa-radio__inner"></span>
      <input
    ...
    methods: {
      handleChange() {
        this.$nextTick(() => {
          ...
          this.isGroup && this.dispatch('faRadioGroup', 'handleChange', this.model);
        });
      }
    }
  };
